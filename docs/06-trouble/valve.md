...
!!! warning "漏洩発見時の初動と報告フロー"
    危険物・高圧ガスの漏洩を発見したら、切り分けより先に初動と報告を優先する。

    1. **発見即時**：製造当直（運転員）へ第一報。漏洩箇所・流体・おおよその規模を伝える。
    2. **退避・立入制限**：漏洩範囲の風下・低所を中心に退避範囲を設定し、着火源・立入を排除する。
    3. **報告の連鎖**：製造当直から保安統括者・電気主任技術者へ速やかに報告し、緊急バイパス切替／緊急停止の判断を仰ぐ。
    4. **法令上の事故報告**：高圧ガス設備での漏洩は高圧ガス保安法上の事故報告義務の対象となる場合がある。報告先・様式・期限は社内保安規定および所管官庁の定めに従う。
