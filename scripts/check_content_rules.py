...
FORBIDDEN = [
    ...
    ("N9", re.compile(r"片道.{0,15}(?<![0-9])28(?![0-9.])\s*Ω"),
...
def self_test():
    ...
    if failures:
        ...
        return 1
    print("[OK] self-test: 正対照12 + 負対照2 + canary3 パス")
    return 0
