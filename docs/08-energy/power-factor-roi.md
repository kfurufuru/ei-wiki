...
<figure>
<svg viewBox="0 0 560 300" width="560" height="300" role="img" aria-labelledby="fig-power-factor-roi-title" style="max-width:100%;height:auto;font-family:sans-serif">
  <title id="fig-power-factor-roi-title">電力三角形。有効電力Pを底辺、無効電力Qを縦、皮相電力Sを斜辺とし、改善前の角θ₁と改善後の角θ₂の差にあたる縦方向の量がコンデンサ補正量Qcにあたることを示す図</title>
  <!-- P base (有効電力) -->
