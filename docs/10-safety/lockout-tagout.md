...
<figure>
<svg viewBox="0 0 640 300" width="640" height="300" role="img" aria-labelledby="fig-lockout-tagout-title" style="max-width:100%; height:auto;" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor">
  <title id="fig-lockout-tagout-title">遮断器のハンドルにロックアウトハスプを掛け、作業者A・B・Cの個人錠を追加した模式図。全員が解錠するまで遮断器は投入できない。</title>
  <!-- 遮断器本体 -->
