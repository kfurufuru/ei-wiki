...
事故・ヒヤリハット・設備トラブルが発生した場合は、被害拡大を防ぐため速やかに以下の順で連絡する。連絡先・時間目安は現場ごとに異なるため、実際の運用は社内規定・工事安全計画書に従うこと。

| 順序 | 対応・報告先 | 内容 |
|------|------------|------|
| 1 | 負傷者の救護・二次災害防止 | 人命最優先。負傷者救護と危険源の隔離（停電・区画封鎖等）を最初に行う |
| 2 | 現場代理人へ第一報 | 発見者は直ちに現場代理人（工事元請）へ連絡 |
| 3 | 発注者側の電気担当・電気主任技術者へ連絡 | 現場代理人から発注者側へ速やかに報告。設備影響の判断を仰ぐ |
| 4 | 法定報告の要否確認 | 重大事故は法令（電気関係報告規則・労働安全衛生関係法令等）に基づく報告要否を確認し、社内規定に従い所管官庁・労働基準監督署へ報告 |

!!! note "連絡系統は事前に共有"
    緊急連絡系統図（誰へ・どの順で連絡するか）は工事開始前の安全打合せで関係者に共有し、現場に掲示しておくこと。
