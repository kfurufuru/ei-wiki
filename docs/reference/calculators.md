...
<figure>
<svg viewBox="0 0 720 260" width="720" height="260" role="img" aria-labelledby="fig-calculators-title" style="max-width:100%;height:auto;" fill="none" stroke="currentColor" stroke-width="1.5">
  <title id="fig-calculators-title">4-20mAループの直列抵抗構成。電源24Vから伝送器、安全バリア300Ω、配線50Ω、DCS受信抵抗250Ωを直列に接続し、合計600Ωが最大ループ抵抗600Ω以下であることを示す</title>
  <!-- 電源 -->
