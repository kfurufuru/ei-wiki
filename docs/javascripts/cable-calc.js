...
(function () {
  // 許容電流 [管路, 気中, ラック]
  // 出典は JIS C 3605 / 内線規程の参考値とされるが、いずれも原本未照合（有償規格）。
  ...
  var CABLE_DB = {
    cv:  [
      { size: 2.0,  amp: [19,  26,  24],  R: 9.42   },
      { size: 3.5,  amp: [26,  36,  33],  R: 5.30   },
      { size: 5.5,  amp: [34,  47,  43],  R: 3.40   },
      { size: 8,    amp: [42,  58,  53],  R: 2.36   },
      { size: 14,   amp: [61,  84,  77],  R: 1.34   },
      { size: 22,   amp: [78,  107, 98],  R: 0.849  },
      { size: 38,   amp: [105, 144, 132], R: 0.491  },
      { size: 60,   amp: [135, 185, 170], R: 0.311  },
      { size: 100,  amp: [175, 240, 220], R: 0.187  },
    ],
    cvt: [
      { size: 14,   amp: [61,  88,  80],  R: 1.34   },
      { size: 22,   amp: [78,  112, 103], R: 0.849  },
      { size: 38,   amp: [105, 152, 139], R: 0.491  },
      { size: 60,   amp: [135, 194, 178], R: 0.311  },
      { size: 100,  amp: [175, 252, 231], R: 0.187  },
      { size: 150,  amp: [210, 302, 277], R: 0.124  },
      { size: 200,  amp: [240, 346, 317], R: 0.0933 },
      { size: 250,  amp: [270, 385, 353], R: 0.0754 },
    ]
  };
  var X = 0.09; // Ω/km（固定）
