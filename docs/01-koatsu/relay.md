...
<figure>
<svg viewBox="0 0 560 320" width="560" height="320" role="img" aria-labelledby="fig-relay-title" style="max-width:100%;height:auto;font-family:sans-serif">
  <title id="fig-relay-title">零相電圧V0を基準軸とし、自回線地絡時と他回線地絡時の零相電流I0ベクトルを位相で描き分けた図。DGRの動作領域を扇形で示す。</title>
