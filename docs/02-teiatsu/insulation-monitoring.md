...
!!! info "法令上の位置づけ"
    低圧電路の絶縁性能は電気設備技術基準で定める水準を満たす必要があり、絶縁監視はその維持・確認を運転中に支援する手段と位置づけられます。常時監視装置の設置自体が一律に義務づけられているわけではないため、自社の保安規程・設備の重要度に応じて導入を判断します。具体的な要求値や条文の適用は一次情報で確認してください。
