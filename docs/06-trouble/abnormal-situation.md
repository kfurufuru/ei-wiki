...
地震後の絶縁抵抗確認：高圧ケーブルは震度5以上で絶縁抵抗測定（5000V メガー）を実施。判定は [絶縁管理](../05-hozen/insulation-management.md) を正典とし、**使用中の高圧ケーブルは 10 MΩ 以上が良、1〜10 MΩ は要注意**。高圧に法定の絶縁抵抗値は無いため、単点の合否より**前回比の急低下**を重視する。
