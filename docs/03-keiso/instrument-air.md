...
!!! tip "「最低気温より 10 °C 低く」の考え方（ISA-7.0.01 由来とされる）"
    加圧露点を**系統がさらされる現地の最低記録周囲温度より少なくとも 10 °C 低くする**、という考え方が広く用いられています。「夏は問題なくても冬に結露・凍結する」ことを防ぐ、最低気温基準の設計思想です。
    この考え方は計装空気品質の規格 ISA-7.0.01 に由来するとされますが、**同規格は有償で本ページでは原本を照合していません**（下記「根拠」参照）。調達仕様・受入判定に使う際は規格原本または自工場のユーティリティ仕様書を正としてください。
...
- **ISA-7.0.01**: 計装空気の品質規格。露点・油分・粒子についての要求が規定されているとされます（**有償・原本未照合**）
