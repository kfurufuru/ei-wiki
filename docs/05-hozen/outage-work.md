...
作業中に感電・アーク・想定外の通電などの異常を検知した場合は、以下の順序で対応する。時間の目安・連絡先・役割は社内の停電作業要領・保安規程に従う。

| 手順 | 対応 | 実施者 |
|------|------|--------|
| 1. 即時中止・退避 | 作業を直ちに中止し、大声で異常を周知して危険範囲から退避する | 異常を検知した作業者・全作業者 |
| 2. 現場指揮 | 現場の作業を統制し、二次災害を防止する | 作業責任者 |
| 3. 速報 | 電気主任技術者・当直長（社内規定の連絡先）へ速やかに一報を入れる | 作業責任者 |
| 4. 救護 | 負傷者がいる場合は救護を最優先し、必要に応じて 119 通報を並行する | 作業責任者・応援者 |
| 5. 復電の保留 | 原因が特定され安全が確認されるまで復電しない。復電の可否は電気主任技術者の許可判断による | 電気主任技術者 |

!!! danger "異常時は自己判断で復電しない"
    異常発生後の復電は、原因究明と安全確認が終わり、電気主任技術者の許可を得るまで行わない。「大丈夫そうだから」という自己判断での再投入は二次災害の直因となる。
...
> 出典: 停電作業を行う場合の措置（検電・短絡接地）は労働安全衛生規則第339条。
