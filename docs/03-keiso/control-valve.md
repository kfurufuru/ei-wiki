...
**2026-08-01 に単位換算から再計算して確認**しました。[計算ツール集](../reference/calculators.md) の換算係数も本ページに合わせています。

計算例（水・10 m³/h・0.3 bar）も再計算し一致を確認: Kv = 10/√0.3 = 18.257（表示は 18.2）、Cv = 18.2/0.865 = 21.0。
