...
<svg viewBox="0 0 420 280" role="img" aria-label="差圧ΔPと流量Qの平方根特性カーブ。Qは√ΔPに比例するため、低流量域ほど傾きが急でΔP分解能あたりの流量変化が小さく、レンジアビリティが悪化する。" style="max-width:100%;height:auto;">
  <!-- axes -->
...
*ΔPを一定刻みで読んでも、低流量域（左端）ほど流量Qの変化が小さくなり、下限側のレンジアビリティが悪化する。*
...
> 出典: ISO 5167（JIS Z 8762）。直管長は代表例であり、絞り比βや配管条件によって規定値は変わる。

---

## 渦流量計

カルマン渦（von Kármán vortex）を利用。三角柱のブラフボディを流れに立てると、流速に比例した周波数で渦が発生する。
