...
(function () {
  ...
  // 温度では変わらないため、20℃基準の R と組み合わせて差し支えない。
  var CABLE_DB = {
    cv:  [
      { size: 2.0,  amp: [19,  23,  23],  R: 9.42,   X50: 0.0992, X60: 0.119  },
      { size: 3.5,  amp: [26,  33,  33],  R: 5.30,   X50: 0.0914, X60: 0.110  },
      { size: 5.5,  amp: [35,  44,  44],  R: 3.40,   X50: 0.0914, X60: 0.110  },
      { size: 8,    amp: [43,  54,  54],  R: 2.36,   X50: 0.0870, X60: 0.104  },
      { size: 14,   amp: [59,  76,  76],  R: 1.34,   X50: 0.0828, X60: 0.0994 },
      { size: 22,   amp: [77,  100, 100], R: 0.849,  X50: 0.0820, X60: 0.0984 },
      { size: 38,   amp: [110, 140, 140], R: 0.491,  X50: 0.0771, X60: 0.0925 },
      { size: 60,   amp: [150, 190, 190], R: 0.311,  X50: 0.0768, X60: 0.0922 },
      { size: 100,  amp: [210, 260, 260], R: 0.187,  X50: 0.0773, X60: 0.0928 },
    ],
    cvt: [
      { size: 14,   amp: [63,  86,  86],  R: 1.34,   X50: 0.107,  X60: 0.128  },
      { size: 22,   amp: [82,  110, 110], R: 0.849,  X50: 0.103,  X60: 0.123  },
      { size: 38,   amp: [110, 155, 155], R: 0.491,  X50: 0.0955, X60: 0.115  },
      { size: 60,   amp: [150, 210, 210], R: 0.311,  X50: 0.0913, X60: 0.110  },
      { size: 100,  amp: [215, 290, 290], R: 0.187,  X50: 0.0881, X60: 0.106  },
      { size: 150,  amp: [275, 380, 380], R: 0.124,  X50: 0.0846, X60: 0.102  },
      { size: 200,  amp: [340, 465, 465], R: 0.0933, X50: 0.0859, X60: 0.103  },
      { size: 250,  amp: [395, 535, 535], R: 0.0754, X50: 0.0836, X60: 0.100  },
    ]
  };
  ...
  window.calcCable = function () {
    ...
    var xKey       = (g('cc_freq') && g('cc_freq').value === '50') ? 'X50' : 'X60';
    ...
    for (var i = 0; i < CABLE_DATA.length; i++) {
      ...
      var vd        = factor * I * (d.R * pf + d[xKey] * sinθ) * L;
