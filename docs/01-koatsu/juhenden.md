...
| 義務 | 内容 |
|------|------|
| 選任義務 | 事業用電気工作物（Electric Facilities for Business Use）を設置する者は電気主任技術者を選任する義務（電気事業法第43条）。高圧受電の自家用電気工作物は規模によらず選任が必要。500kW・2000kWは保安管理業務の外部委託承認や許可主任技術者制度の区分であり、選任義務の有無を分ける閾値ではない |
