...
```mermaid
flowchart LR
    A[電力会社<br/>特高系統] --> B[責任分界点<br/>PAS／受電点<br/>メーターボックス]
    B --> C[屋外特高変電所<br/>以降の自家設備]
    subgraph S1[電力会社の責任・保守]
        A
    end
    subgraph S2[自家設備の責任・保守<br/>電気主任技術者の管轄]
        C
    end
    style B fill:#f6c85f,stroke:currentColor,color:#000
```

*責任分界点（PAS／受電点）を境に、電源側＝電力会社、負荷側＝自家設備に責任が分かれる。*
...
| 義務 | 内容 |
|------|------|
| 選任義務 | 自家用電気工作物（500kW以上）は電気主任技術者の選任が義務（電気事業法第43条） |
| 保安規程の制定 | 設備の工事・維持・運用に関する保安規程を定め、届出（電気事業法第42条） |
