...
description: 当工場の主要取り扱い物質（フォトレジスト用ポリマー・重合性モノマー・溶剤）の特性と計装上の注意
tags: [当工場, プロセス, 防爆, 重合性モノマー]
audience: [電気担当, 保全担当]
...
|------|------|--------|---------|------|----------------|
| 有機溶剤（フォトレジスト系） | フォトレジスト用ポリマー製造 | 低い（〜30℃程度） | 1〜数% | 有機溶剤中毒 | Zone 1/2判定・防爆機器必須 |
| 重合性モノマー | 製品 | 138℃ | 2.8〜31% | 神経毒・発がん性 | 計器接液部SUS316L/PTFE必須 |
