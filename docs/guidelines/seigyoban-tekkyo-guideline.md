...
| 自家用電気工作物（最大電力 500 kW 未満の需要設備）の工事 | 第一種電気工事士（電圧 600 V 以下で使用する部分の工事〔電線路に係るものを除く〕は認定電気工事従事者でも可＝簡易電気工事） |
| 自家用電気工作物（500 kW 以上） | 電気工事士法の対象外。電気主任技術者の保安監督のもとで施工 <!-- lint-ok: 20260710-senin-500kw 電気工事士法の資格区分・選任義務の記述ではない --> |
...
| 区分 | 品目 | 用途・使用前確認 |
|------|------|----------------|
| 測定器 | 低圧検電器 | 活殺判定・無電圧確認。**使用前にテストボタンか既知の電源で動作確認**（本ガイドライン必須の手順。法令上の位置づけは第12章の関連法令表を参照） |
...
4. 開放した開閉器に**操作禁止札＋施錠（ロックアウト・タグアウト、LOTO）**を行う。**施錠は作業に入る各自が自分の錠で行う（1人1錠）**（労働安全衛生規則 第339条第1項第一号。条文は施錠・通電禁止表示・監視人の**選択制**で、「札＋施錠＋1人1錠」は条文より厳しい本ガイドラインの基準 → [LOTO](../10-safety/lockout-tagout.md)）
...
- **防火区画**を貫通していた配管・ケーブルの穴は、耐火材（モルタル・耐火パテ）で復旧する（建築基準法施行令 第112条第20項——管と防火区画とのすき間を「モルタルその他の不燃材料」で埋める——の義務。放置すると消防の立入検査での指摘や延焼リスク）
...
| 法令 | 関連箇所 | 本ガイドラインとの対応 |
|------|---------|----------------------|
| [労働安全衛生規則](https://laws.e-gov.go.jp/law/347M50002000032) | 第339条（停電作業を行う場合の措置） | 開閉器の施錠／通電禁止の表示／監視人の**いずれか**（第1項第一号）／残留電荷の放電（同第二号）／**高圧・特別高圧であった電路**の検電・短絡接地（同第三号） |
| 労働安全衛生規則 | 第350条（作業指揮者） | 停電作業の指揮・確認体制（2-4節） |
| 労働安全衛生規則 | 第352条（電気機械器具等の使用前点検等） | 使用前点検（2-5節）。ただし同条の表が使用前点検を義務付ける「検電器具」は**第339条第1項第三号のもの（高圧・特別高圧の停電確認用）**で、低圧検電器の使用前確認は本ガイドラインの上乗せ基準 |
...
| 電技省令 | 第2条第1項第一号（電圧の種別）・第58条（低圧電路の絶縁） | 低圧の定義＝交流 600 V 以下／直流 750 V 以下（冒頭の適用範囲）・残置回路の絶縁測定基準（8-2節）→ [解説ページ](https://kfurufuru.github.io/denken-wiki/articles/kijun/58/) |
| 建築基準法施行令 | 第112条第20項（防火区画の貫通部） | 貫通部の耐火復旧（7-3節）。管と防火区画とのすき間をモルタルその他の不燃材料で埋める |
...
| 作成者 | 設備担当部門 電気計装担当（例。事業場の役割名に置き換え） |
| 審査者 | 電気計装リーダー・安全衛生担当（例） |
| 承認者 | 電気主任技術者または設備部門長 |
| 管理元 | 設備担当部門 電気計装グループ（例） |
...
| v2.2 | 2026-08-01 | 法令帰属の一次照合是正: 防火区画貫通の根拠を消防法令→建築基準法施行令第112条第20項へ、低圧検電器の使用前確認を安衛則第352条の義務→上乗せ基準へ区分。第339条の選択制を明記し「根拠」章を新設 | （運用時に記入） |
...
第12章の関連法令表を含む本ガイドラインの法令記述を、**2026-08-01 に e-Gov 法令検索の現行条文で逐語照合**しました（初回照合 2026-06-11 の再照合＋範囲拡大）。区分は次のとおりです。

### 一次照合済みの法定事項（2026-08-01 e-Gov 逐語照合）

- **低圧の定義**（冒頭の適用範囲: 交流 600 V 以下／直流 750 V 以下）: 電技省令**第2条第1項第一号**。
- **資格区分**（2-4節）: 電気工事士法**第2条第2項**（同法の「自家用電気工作物」は最大電力 500 kW 未満の需要設備等に限られ、それ以外の需要設備は同法の資格規制の対象外）・**第2条第3項**（「電気工事」＝設置し、又は変更する工事。軽微な工事は施行令第1条に列挙）・**第3条第1項**（自家用は第一種電気工事士）・**第3条第2項**（一般用等は第二種以上）・**第3条第4項**（簡易電気工事は認定電気工事従事者可）。簡易電気工事の範囲「電圧 600 V 以下で使用する自家用電気工作物に係る電気工事（電線路に係るものを除く）」は同法施行規則**第2条の3**。
- **特別教育**（2-4節）: 義務の本体は労働安全衛生法**第59条第3項**、対象業務は安衛則**第36条第四号**（低圧の充電電路の敷設・修理、充電部分が露出した開閉器の操作等）。受講区分ごとの学科・実技時間は告示（安全衛生特別教育規程）で定まり、[特別教育](../10-safety/special-education.md) が正典です。
- **停電作業**（第5章）: 安衛則**第339条第1項**（第一号＝施錠・通電禁止表示・監視人の**選択制**／第二号＝残留電荷の放電／第三号＝検電・短絡接地は**高圧又は特別高圧であった電路**に限る）・**第2項**（復電前確認）。「1人1錠」「全端子検電」「活-死-活確認」は条文より厳しい実務基準です。条文対応の詳細は [停電作業](../05-hozen/outage-work.md)・[LOTO](../10-safety/lockout-tagout.md) が正典。
- **作業指揮者**（2-4節）: 安衛則**第350条**。第339条等の作業では、作業期間・内容・電路系統を労働者に周知し、作業指揮者を定めて、直接指揮と「停電の状態、開閉器の施錠・通電禁止に関する所要事項の表示**又は**監視人の配置の状態、短絡接地器具の取付けの状態を確認した後の着手指示」（第三号。**施錠／表示／監視人は選択**なので、実際に採った措置の状態を確認する）を行わせます。
- **使用前点検**（2-5節）: 安衛則**第352条**（その日の使用開始前の点検）。ただし同条の表の「検電器具」（点検事項: 検電性能）は**第339条第1項第三号の検電器具＝高圧・特別高圧の停電確認用**を指します。低圧検電器の使用前・使用後確認は条文上の義務ではなく、本ガイドラインの上乗せ基準です。**かつて本ページは低圧検電器の使用前確認に第352条を直接充てていましたが、条文の範囲を広く取り過ぎのため 2026-08-01 に是正しました。**
- **防火区画の貫通部**（7-3節）: 建築基準法施行令**第112条第20項**（給水管・配電管その他の管が防火区画を貫通する場合、管と防火区画とのすき間をモルタルその他の不燃材料で埋める）。**かつて本ページはこれを「消防法令上の義務」としていましたが、義務の根拠は建築基準法令のため 2026-08-01 に是正しました**（消防の立入検査で指摘され得るのは運用実態であり、根拠法令の帰属とは別です）。
- **マニフェスト**（8-3・8-5節）: 廃棄物処理法**第12条の3第2項**（交付者の写し保存）→同法施行規則**第8条の21の2**で**5年**、**第6項**（返送された写しの保存）→規則**第8条の26**で**5年**。
- **PCB 処分期限**（7-1節）: PCB特別措置法**第14条**→同法施行令**第7条**「法の施行の日から**令和9年3月31日**（＝2027年3月31日）まで」（高濃度以外＝いわゆる低濃度 PCB 廃棄物の処分期間）。
- **電気事故報告**: 電気関係報告規則**第3条**（限定列挙。対象・期限は [電気事故対応と報告](../09-hoantokei/jiko-taiou.md) が正典）。

### 法定でない実務事項（本ガイドラインの上乗せ基準）

- 四大原則・作業停止権限・ホールドポイント・札の色分けと記載事項・両端原則・仮番号札・全端子検電・活-死-活確認・1人1錠とグループロックボックス・唱和定型句・写真記録標準・切断1本ずつのサイクル・2名以上の作業体制——いずれも法令の要求ではなく、感電・誤切断防止のための実務・社内基準です。
- 記録の保管期間の例示（完了報告書 5 年等）は事業場規程で定める目安であり、法定なのはマニフェスト関係（5年）等に限られます。
- 測定器の CAT 定格（CAT III 以上を目安）・絶縁手袋の空気試験・金属装身具の取り外しは安全実務であり、個別条文への照合は行っていません（honest hold）。

### 照合の限界（honest hold）

- OSHA 29 CFR 1910.147・OSHA eTool・HSE HSG85 は米英の制度で、国内での法的拘束力はなく、逐語照合も行っていません（実務強化の参考としてのみ引用）。
- 安全衛生特別教育規程（告示）は e-Gov 未収録のため本ページでは時間数を記載せず、[特別教育](../10-safety/special-education.md)（厚生労働省法令等データベースで照合済み）に委ねます。
- 水銀廃棄物（水銀リレー等）の処理区分、火気使用許可の運用は個別法令・事業場ルールへの照合を行っていません。
...
- 労働安全衛生法（昭和47年法律第57号）: [第59条](https://laws.e-gov.go.jp/law/347AC0000000057#Mp-Ch_6-At_59)
- 労働安全衛生規則（昭和47年労働省令第32号）: [第36条](https://laws.e-gov.go.jp/law/347M50002000032#Mp-Pa_1-Ch_4-At_36)・[第339条](https://laws.e-gov.go.jp/law/347M50002000032#Mp-Pa_2-Ch_5-Se_3-At_339)・[第350条](https://laws.e-gov.go.jp/law/347M50002000032#Mp-Pa_2-Ch_5-Se_5-At_350)・[第352条](https://laws.e-gov.go.jp/law/347M50002000032#Mp-Pa_2-Ch_5-Se_5-At_352)
- 電気設備に関する技術基準を定める省令（平成9年通商産業省令第52号）: [第2条](https://laws.e-gov.go.jp/law/409M50000400052#Mp-Ch_1-Se_1-At_2)
- 電気工事士法（昭和35年法律第139号）: [第2条](https://laws.e-gov.go.jp/law/335AC0000000139#Mp-At_2)
- 建築基準法施行令（昭和25年政令第338号）: [第112条](https://laws.e-gov.go.jp/law/325CO0000000338#Mp-Ch_4-At_112)
...
*最終確認: 2026-08-01 | ステータス: v2.2 | 種別: 実務ガイドライン（試験対策ページではなく現場作業の標準手順書） | 法令条番号の照合: e-Gov 2026-08-01 逐語再照合（安衛則・電気工事士法・電技省令・建築基準法施行令・廃棄物処理法・PCB特措法。詳細は「根拠」章） | v2.2: 法令帰属2件の是正（詳細は第13章の改訂履歴）*
