...
| 500V | 低圧電路（AC200V 級）・計装ケーブル | 低圧の標準。内線規程・実務慣行 |
...
低圧電路の電線相互間および電路と大地間の絶縁抵抗は、開閉器・過電流遮断器で区切れる電路ごとに、電気を使用する状態で下表の値以上に保つことが電気設備技術基準省令 第58条で定められている。これは**最低基準**であり、これを下回ると法令違反となる。
