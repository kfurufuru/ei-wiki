...
<figure>
<svg viewBox="0 0 560 430" width="560" height="430" role="img" aria-labelledby="fig-hv-motor-title" style="max-width:100%;height:auto;" xmlns="http://www.w3.org/2000/svg">
  <title id="fig-hv-motor-title">始動方式の始動電流と始動トルクのトレードオフ散布図。直入れ・リアクトル始動・コンドルファ始動を対直入れ比でプロット</title>
  <!-- 軸 -->
