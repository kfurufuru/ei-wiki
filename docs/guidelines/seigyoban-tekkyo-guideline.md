...
!!! abstract "30秒まとめ — この工事で最も危険な3点"
    1. **労力の7割は「切る前」にある** — 調査・札付けが工事の本体。当日の切断は「確認して切るだけ」にするのが正しい配分（第1章）。
    2. **主幹を切っても感電する** — 渡り制御線・UPS・コンデンサの残留電荷は主幹と無関係に生きている。だから「全端子検電」まで行う（5-4節）。
    3. **不明ケーブルは切らない** — 「行先・用途・活殺」の3点が確定するまで切断禁止。分からないものは残置か協議へ（四大原則2・第3章）。
