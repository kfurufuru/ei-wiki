...
```mermaid
pie title ヒヤリハット発生タイミング分布（実データではなく理解用の概念図）
    "作業開始直後（準備段階の省略）" : 35
    "長時間作業の後半（集中力低下）" : 25
    "作業終了時（復帰確認の省略）" : 25
    "引き継ぎ・交代時（情報伝達ミス）" : 15
...
| 区分 | 誰に | いつまでに | 順序 |
|------|------|-----------|------|
| 通常のヒヤリハット | 班長 | 当日中に提出 | 書面で提出 → 班長が集約 |
| 重大につながり得るヒヤリ<br>（感電未遂・防爆エリアのガス関連・保護継電無効化 等） | 監督者 | 発見後ただちに（速やかに） | 口頭で第一報 → その後に書面 |
| 週次のとりまとめ | 安全衛生担当 | 週次 | 班長が集約して報告 |

!!! warning "重大につながり得るヒヤリは「速やかに」口頭第一報"
    感電未遂・防爆エリアのガス関連・保護継電器の無効化など重大事故に直結し得るヒヤリハットは、書面を待たず発見後ただちに監督者へ口頭で第一報する。具体的な報告時限・様式は社内の安全衛生規定に従う。
