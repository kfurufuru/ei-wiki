...
- **SIL の定義帯（PFDavg・PFH）**: JIS C 0508-1:2012 表2（低頻度作動要求モード: SIL 1＝10⁻²以上10⁻¹未満 〜 SIL 4＝10⁻⁵以上10⁻⁴未満）・表3（高頻度作動要求または連続モード: SIL 1＝10⁻⁶以上10⁻⁵未満 〜 SIL 4＝10⁻⁹以上10⁻⁸未満、単位 1/h）。JIS C 0508-1 は IEC 61508-1:2010 の対応規格。**原本未照合・二次資料のみ**（2026-07-30 の照合は非公式な全文転載サイトによるもので、出典として扱いません。表番号・帯域の数値は JSA/IEC 発行の原本で確認してから引用してください）。
